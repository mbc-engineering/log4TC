...
namespace Mbc.Log4Tc.Output.NLog.NLogTarget
{
    /// <summary>
    ...
    /// </summary>
    [Target("ApplicationInsightsTargetLog4Tc")]
    public sealed class ApplicationInsightsTargetLog4Tc : TargetWithLayout
    {
        private TelemetryClient _telemetryClient;
        private DateTime _lastLogEventTime;
        private global::NLog.Layouts.Layout _instrumentationKeyLayout = string.Empty;

        /// <summary>
        /// Initializers a new instance of ApplicationInsightsTarget type.
        /// </summary>
        public ApplicationInsightsTargetLog4Tc()
        {
            this.Layout = @"${message}";
        ...
        {
            get => (this._instrumentationKeyLayout as global::NLog.Layouts.SimpleLayout)?.Text ?? null;
        ...
        internal void BuildPropertyBag(LogEventInfo logEvent, ITelemetry trace)
        {
            ...
            trace.Context.Cloud.RoleName = "log4TC";
...
#pragma warning restore CS0618 // Type or member is obsolete
            ...
            string instrumentationKey = this._instrumentationKeyLayout.Render(LogEventInfo.CreateNullEvent());
            if (!string.IsNullOrWhiteSpace(instrumentationKey))
            {
                this._telemetryClient.Context.InstrumentationKey = instrumentationKey;
            }
        ...
        private void SendException(LogEventInfo logEvent)
        {
            ...
            this._telemetryClient.Track(exceptionTelemetry);
        }
        ...
        private void SendTrace(LogEventInfo logEvent)
        {
            ...
            this._telemetryClient.Track(trace);
        }
    }
}
